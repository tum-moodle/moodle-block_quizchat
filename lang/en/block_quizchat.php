...
$string['privacy:metadata:block_quizchat_messages:mgroupid'] = 'The Moodle Group ID that this message is addressed to.';
$string['privacy:metadata:block_quizchat_messages:mgroupingid'] = 'The Moodle Grouping ID that this message is addressed to.';
$string['privacy:metadata:block_quizchat_messages:gname'] = 'The Moodle Group or Grouping name that this message is addressed to.';
...
$string['enableopenbefore'] = 'Enable';
$string['openbefore'] = 'Chat open before quiz (minutes)';
$string['openbefore_help'] = 'If enabled, how many minutes before the quiz starts will the chat open?';
$string['available_after_duration_1'] = 'Access to Quizchat is restricted until ';
$string['available_after_duration_2'] = ' minutes before the quiz start time.';
$string['enabletemplatemenu'] = 'Enable template menu';
$string['enabletemplatemenu_desc'] = 'If checked, the template menu will be available to be activated in Quizchat blocks.';
$string['templatemessagesettings'] = 'Template Messages settings';
$string['templatemessagesettings_desc'] = 'The template messages allow instructors to quickly access predefined responses.';
$string['createtemplatemessage'] = 'Create template message';
$string['generalsettings'] = 'General settings';
$string['currenttemplatemessages'] = 'Template messages';
$string['placeholder_title_setting'] = 'Title';
$string['placeholder_message_setting'] = 'Message';
$string['save_btn_settings'] = 'Save';
$string['cancel_btn_settings'] = 'Cancel';
$string['table_action_settings'] = 'Action';
$string['enabletemplate_sitelevel'] = 'Enable';
$string['table_availability_settings'] = 'Availability';
$string['table_createdby_settings'] = 'Created by';
$string['table_moddate_settings'] = 'Modified date';
$string['table_enabled_settings'] = 'enabled';
$string['table_disabled_settings'] = 'disabled';
$string['btn_edit'] = 'Edit';
$string['btn_delete'] = 'Delete';
$string['confirm_delete_template'] = 'Are you sure you want to delete this template message?';
$string['template_saved'] = 'Template changes have been saved successfully!';
$string['update_btn_settings'] = 'Update';
$string['config_templatemsgsmenu'] = 'Enable template messages menu in block';
$string['block_quizchat_temp_menu'] = 'Select template message';
$string['empty_temp_menu'] = 'No template messages found.';
$string['config_usecentraltempmsgs'] = 'Use central template messages';
$string['centraltempmsgs'] = 'Central template messages';
$string['quiztempmsgs'] = 'Quiz template messages';
$string['privacy:metadata:block_quizchat_templates'] = 'The created template messages (predefined responses)';
$string['privacy:metadata:block_quizchat_templates:id'] = 'The template message ID.';
$string['privacy:metadata:block_quizchat_templates:title'     ] = 'The template message title.';
$string['privacy:metadata:block_quizchat_templates:message' ] = 'The template message.';
$string['privacy:metadata:block_quizchat_templates:type'    ] = 'Whether the template messsage is created to be used only in quiz or for central usage.';
$string['privacy:metadata:block_quizchat_templates:isenabled'    ] = 'Whether the template message is enabled to be used.';
$string['privacy:metadata:block_quizchat_templates:timecreated'  ] = 'The time when the template was created';
$string['privacy:metadata:block_quizchat_templates:timemodified'  ] = 'The time when the template was modified';
